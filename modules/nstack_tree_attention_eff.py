...
class WeightMaskEff(nstack_att.WeightMask):
    ...
    def mask_weights_wmask(cls, attn_weights, pad_mask):
        ...
        attn_weights = attn_weights.float().masked_fill_(pad_mask.bool(), float('-inf')).type_as(attn_weights)
        return attn_weights
    ...
    def mask_weights_leave_subtree_wmask(cls, attn_weights, pad_mask):
        ...
        all_weights[:, :, :tk].masked_fill_(leave_pad_mask.bool(), float('-inf'))
        all_weights[:, :, tk:].masked_fill_(node_pad.bool(), float('-inf'))
