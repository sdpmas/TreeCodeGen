...
PARSER_PORT = str(os.environ.get('PARSER_PORT', 9000))
...
class NStackDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # print("pstrings: ",parse_strings)
            # print("token_set: ",token_string_set)
        except Exception as e:
...
class NstackTreeBuilder(object):
    ...
    def retrieve_tree_data(self, dataloader):
        ...
        for i_batch, sample_batched in enumerate(dataloader):
            if self.unify_tree:
                ...
                try:
                    # print("the s is ",sample_batched['pstring'])
                    ...
                    if self.ignore_error:
                        ...
                        raise e
            #TODO: do we need to index into 0?
    ...
    def export_text_to_tree_strings(
        ...
        """notice that the batch size is 1"""
